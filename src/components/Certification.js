...
import act1 from "../assets/documents/2022.pdf";
import act2 from "../assets/documents/2023.pdf";
import act3 from "../assets/documents/2024.pdf";
...
const CertificationBlock = () => {
  ...
  return (
    <AboutBlock
      image_main={img_training_main}
      image_small={img_exam_small}
      title={<Title />}
    >
        ...
        <Button.Group size="massive" vertical>
          ...
          >
            <Button.Content visible>
              {t("trainings_certification_pdf1")}
            </Button.Content>
          ...
          >
            <Button.Content visible>
              {t("trainings_certification_pdf2")}
            </Button.Content>
            <Button.Content hidden>
              <Icon name="down arrow" />
              {t("application_download")}
          ...
          >
            <Button.Content visible>
              {t("trainings_certification_pdf3")}
            </Button.Content>
            <Button.Content hidden>
              <Icon name="down arrow" />
              {t("application_download")}
          ...
          >
            <Button.Content visible>
              {t("trainings_certification_pdf4")}
            </Button.Content>
            <Button.Content hidden>
              <Icon name="down arrow" />
              {t("application_download")}
